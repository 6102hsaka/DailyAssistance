  		...
  		<div class="collapse navbar-collapse" id="navbarNav">
    		<ul class="navbar-nav ml-auto">
	      		...
	      		<li class="nav-item active">
	        		<a class="nav-link" href="listtodo">List Todo <span class="sr-only">(current)</span></a>
	      		</li>
    		</ul>
  		</div>
	</nav>
	
	<section class="container shadow" id="mylist">
		...
		<c:forEach items="${todos}" var="todo">
			<div class="row border">
				<div class="col-2"> <c:out value="${todo.title}"/> </div>
				<div class="col-5"> <c:out value="${todo.description }"/> </div>
				<div class="col-2"> <c:out value="${todo.targetDate }"/> </div>
				<div class="col-1 py-2"> <a class="btn btn-success" href="/delete?id=${todo.id}">Completed</a> </div>
		</div>
		</c:forEach>
	</section>
